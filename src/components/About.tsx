    ...
    <div className="px-5 py-20 lg:py-28 lg:px-20 flex flex-col items-center gap-4 lg:flex-row lg:justify-between lg:gap-0 lg:items-end">
      <div className="flex flex-col gap-5 lg:w-[50%]">
        ...
        <p className="font-Oswald text-md text-[#0B2447] font-md leading-8">
          ...
          in computer programming.The "Hello World" things comes when I was
          taking my SHS work immersion(OJT), it was HTML, CSS and a little bit
          of PHP and WordPress that I've been using that time and that was my
          first experience in front-end developing. It was God's plan for me to
          engaged in a software field because it was the passion that I have
          been looking when I was undecided what path to take in life.
        </p>
